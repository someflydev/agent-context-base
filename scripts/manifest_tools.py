...
ARCHETYPE_PATHS = {
    ...
    "tenant-aware-backend-api": "context/archetypes/tenant-aware-backend-api.md",
    "cli-tool": "context/archetypes/cli-tool.md",
    "terminal-tui": "context/archetypes/terminal-tui.md",
    "terminal-dual-mode": "context/archetypes/terminal-dual-mode.md",
    "data-pipeline": "context/archetypes/data-pipeline.md",
    "data-acquisition-service": "context/archetypes/data-acquisition-service.md",
...
STACK_PATHS = {
    ...
    "python-fastapi-pyjwt-rbac": "context/stacks/python-fastapi-pyjwt-rbac.md",
    "typescript-hono-jose-rbac": "context/stacks/typescript-hono-jose-rbac.md",
    "go-echo-golang-jwt-rbac": "context/stacks/go-echo-golang-jwt-rbac.md",
    "rust-axum-jsonwebtoken-rbac": "context/stacks/rust-axum-jsonwebtoken-rbac.md",
    "java-spring-jjwt-rbac": "context/stacks/java-spring-jjwt-rbac.md",
    "kotlin-http4k-jjwt-rbac": "context/stacks/kotlin-http4k-jjwt-rbac.md",
    "ruby-hanami-ruby-jwt-rbac": "context/stacks/ruby-hanami-ruby-jwt-rbac.md",
    "elixir-phoenix-joken-rbac": "context/stacks/elixir-phoenix-joken-rbac.md",
    ...
    "parquet": "context/stacks/parquet.md",
    "minio": "context/stacks/minio.md",
    "parquet-minio": "context/stacks/parquet-minio.md",
    "nats-jetstream": "context/stacks/nats-jetstream.md",
    "nats-jetstream-mongo": "context/stacks/nats-jetstream-mongo.md",
    ...
    "terminal-python-typer-textual": "context/stacks/terminal-python-typer-textual.yaml",
    "terminal-python-click-blessed": "context/stacks/terminal-python-click-blessed.yaml",
    "terminal-rust-clap-ratatui": "context/stacks/terminal-rust-clap-ratatui.yaml",
    "terminal-rust-argh-tui-realm": "context/stacks/terminal-rust-argh-tui-realm.yaml",
    "terminal-go-cobra-bubbletea": "context/stacks/terminal-go-cobra-bubbletea.yaml",
    "terminal-go-urfave-tview": "context/stacks/terminal-go-urfave-tview.yaml",
    "terminal-typescript-commander-ink": "context/stacks/terminal-typescript-commander-ink.yaml",
    "terminal-typescript-yargs-blessed": "context/stacks/terminal-typescript-yargs-blessed.yaml",
    "terminal-java-picocli-lanterna": "context/stacks/terminal-java-picocli-lanterna.yaml",
    "terminal-java-jcommander-jline": "context/stacks/terminal-java-jcommander-jline.yaml",
    "terminal-ruby-thor-tty": "context/stacks/terminal-ruby-thor-tty.yaml",
