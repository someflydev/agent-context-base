...
def get_files(root):
    ...
    for dirpath, dirnames, filenames in os.walk(root):
        ...
        for f in filenames:
            ...
            # The only difference from previous: DO NOT SKIP HIDDEN FILES here
            # except .git which is in EXAMPLE_SKIP_PATH_PARTS
...
with open(registry_path, "a", encoding="utf-8") as f:
    for f_path in new_files:
        ...
        elif f_path.endswith(".gitignore"): language = "git"
