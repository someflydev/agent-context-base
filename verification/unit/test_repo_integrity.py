...
class RepoIntegrityTests(unittest.TestCase):
    def test_required_directories_exist(self) -> None:
        required = (
            ...
            "verification/examples/dart",
            "verification/examples/clojure",
            "verification/examples/ocaml",
            ...
            "verification/scenarios/dart_dartfrog_min_app",
            "verification/scenarios/clojure_kit_nextjdbc_hiccup_min_app",
            "verification/scenarios/ocaml_dream_caqti_tyxml_min_app",
