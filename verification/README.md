...
The acquisition layer now also includes real Dart, Ruby, and OCaml examples alongside the earlier Clojure, Scala, and Kotlin additions, but those sync surfaces remain `structure-verified` until compile-aware or runtime acquisition harnesses exist.
